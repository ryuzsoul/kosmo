...
<div class="col-12">			 
	...
	<nav class="navbar navbar-expand-sm bg-light navbar-dark">
		...
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class="nav-link text-dark" href="../Board1/BoardList.jsp">자유게시판</a>
			</li>
			<li class="nav-item">
...
%>
		  <!-- loged out -->
			...
			<li class="nav-item">
				<a class="nav-link text-dark" href="Login.jsp"><i class='fas fa-sign-in-alt' style='font-size:20px'></i>로그인</a>
			</li>
<%
} else{
%>
		  <!-- loged in -->
			...
			<li class="nav-item">
				<a class="nav-link text-dark" href="Logout.jsp"><i class='fas fa-sign-out-alt' style='font-size:20px'></i>로그아웃</a>
			</li>
<%
}
%>
